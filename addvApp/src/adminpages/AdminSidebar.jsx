  ...
  return (
    <div className="oc">
      <nav className="navbar" style={{ backgroundColor: "black" }}>
        ...
        <div className="logo">Recharge Zone</div>
        <ul className={isSidebarOpen ? "nav-links open" : "nav-links"}>
          <li
            ...
            // value="courses"
          >
            <Link to="/adminprepaidplans" className="route-link">
              View Prepaid
            </Link>
          </li>

          <li className="nav-item" onClick={closeSidebar}>
            <Link to="/adminpostpaidplans" className="route-link">
              View Postpaid
            </Link>
          </li>
          <li className="nav-item" onClick={closeSidebar}>
            <Link to="/usermanag" className="route-link">
              Manage Users
            </Link>
          </li>
      ...
      <div className={isSidebarOpen ? "sidebar open" : "sidebar"}>
        <ul className="sidebar-menu">
          ...
          <Link to="/stusettings">
            <li className="sidebar-item">
              <SettingsIcon className="sbar-sett-1"></SettingsIcon>
              {"                   "}Settings
            </li>
          </Link>
          <Link to="/help">
