...
public class RechargePlansService {
    ...
    public List<RechargePlans> getRechargePlanByServiceProviderAndPlanType(String serviceProvider, String planType) {
        return rechargePlansRepository.findByServiceproviderAndPlanType(serviceProvider, planType);
    }
